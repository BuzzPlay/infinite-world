# Contributing to Infinite World

Thanks for helping improve Infinite World.

## Before opening an issue

- Search existing issues first.
- Use the feature request form for product ideas and new interaction workflows.
- Use the bug report form for reproducible problems.
- Do not include API keys, stream keys, OAuth tokens, or private media in an issue.
- For security concerns, do not open a public issue with sensitive details.
...
Join the [Discord community](https://discord.gg/bYdVPGqEsf) for questions, experiments, and development discussion.
