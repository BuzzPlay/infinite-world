...
function DrawerContent({
  ...
  bar = true,
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Content> & { bar?: boolean }) {
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        {bar ? <div className="mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full bg-muted group-data-[vaul-drawer-direction=bottom]/drawer-content:block" /> : null}
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
