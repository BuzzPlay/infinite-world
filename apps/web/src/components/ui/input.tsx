...
export function Input({ className, type, variant = 'default', size = 'sm', ...props }: InputProps) {
  return (
    <input
      type={type}
      data-slot="input"
      ...
      className={cn(
        ...
        'focus:border-brand-blue focus:border focus:outline-none',
        ...
        variant === 'transparent' &&
          'text-foreground border-border focus:border-brand-blue bg-transparent focus:border focus:outline-none',
        variant === 'popover' &&
          'bg-popover text-foreground border-border focus:border-brand-blue focus:border focus:outline-none',
        size === 'xs' && 'h-8 text-xs',
        size === 'sm' && 'h-9 text-sm',
