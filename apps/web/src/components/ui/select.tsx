...
export type SelectTriggerProps = Omit<
  ...
  'size'
> &
  TriggerVariantProps & { arrow?: boolean };
...
>(({ className, children, size = 'md', description, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      description && 'items-start [&>[data-slot=select-item-indicator]]:top-2',
      className,
    )}
    {...props}
  >
    ...
    {description ? (
      <div className="flex min-w-0 flex-col gap-0.5">
        ...
        <span className="max-w-[260px] text-[11px] leading-snug text-muted-foreground">
          {description}
        </span>
      </div>
    ) : (
