...
import { SlidingTabIndicator } from './sliding-tab-indicator';
...
function TabsTriggerCompact({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      value={value}
      className={cn(
        'focus-visible:ring-brand-blue relative z-10 inline-flex flex-1 cursor-pointer items-center justify-center border border-transparent text-xs font-medium whitespace-nowrap focus-visible:ring-[0.6px] focus-visible:outline-none',
