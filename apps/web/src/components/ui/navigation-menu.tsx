...
export function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        'top-0 left-0 w-full p-1 data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out md:absolute md:w-auto',
        className,
      )}
      {...props}
    >
      <div className="rounded-sm bg-muted p-0.5">{children}</div>
    </NavigationMenuPrimitive.Content>
  );
}
...
export function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        'flex flex-col gap-1 rounded-sm p-2 text-sm outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:ring-2 focus-visible:ring-ring/50 data-[active=true]:bg-accent/50 [&_svg:not([class*="size-"])]:size-4',
        className,
      )}
      {...props}
    />
